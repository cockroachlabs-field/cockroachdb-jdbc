...
import io.cockroachdb.jdbc.meta.DatabaseMetaDataProxy;
...
public class CockroachConnection extends WrapperSupport<Connection> implements Connection {
    ...
    protected CockroachConnection(Connection delegate, ConnectionSettings connectionSettings) {
        ...
        this.queryProcessor = Optional.ofNullable(connectionSettings.getQueryProcessor())
                .orElse((connection, sql) -> sql);
    }
    ...
    public Statement createStatement() throws SQLException {
        return new CockroachStatement(getDelegate().createStatement(), queryProcessor);
    }

    @Override
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        final String finalQuery = queryProcessor.processQuery(this, sql);
    ...
    public Statement createStatement(int resultSetType, int resultSetConcurrency) throws SQLException {
        return new CockroachStatement(getDelegate().createStatement(resultSetType, resultSetConcurrency),
                queryProcessor);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
            throws SQLException {
        String finalQuery = queryProcessor.processQuery(this, sql);
    ...
    protected void checkClosed() throws SQLException {
        if (isClosed()) {
            throw new CockroachException("This connection has been closed",
